  ...
  return (
    <div className="space-y-10">
      ...
      <AppContainer className=" relative">
        <Image
          src={"/images/informasi-pelayanan/tindakan-proaktif/Rev_SP 4.webp"}
          alt=""
          height={1000}
          width={1000}
            ...
            <Card>
              ...
              <CardFooter className="flex justify-center place-items-center">
                <Button asChild>
                  <a
                    download
                    href="/pdf/12-14 Peraturan LPSK No. 1 Tahun 2024 tentang Standar Pelayanan di Lingkungan LPSK.pdf"
